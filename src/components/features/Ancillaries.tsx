...
interface AncillariesProp {
  flights:IFlight[]
}
const Ancillaries:React.FC<AncillariesProp> = ({flights}) => {
 const flight = flights[1]
  return (
    <FeatureCard title='Ancillaries' description='Let your customers book premium sears and pay for additional baggage.'>
